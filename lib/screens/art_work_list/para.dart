...
import 'package:grams_porto/screens/art_work_list/location.dart';
import 'package:grams_porto/screens/art_work_list/location_list_item.dart';
...
class ExampleParallax extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double pSpace = platformInfo['pSpace'];
    return Scaffold(
      appBar: AppBar(
